    ...
    <!-- BEGIN JAVASCRIPT -->
      ...
      <!-- BOOTSTRAP-DIALOG - VENTANA DIALOGO -->
      <script src="<?= base_url(); ?>assets/js/libs/bootstrap-dialog/bootstrap-dialog.min.js"></script>

      <!-- HIGHCHARTS - GRAFICOS -->
      <script type="text/javascript" src="<?= base_url(); ?>assets/libs/highcharts/code/highcharts.js"></script>
      <script type="text/javascript" src="<?= base_url(); ?>assets/libs/highcharts/code/highcharts-3d.js"></script>
      <script type="text/javascript" src="<?= base_url(); ?>assets/libs/highcharts/code/modules/cylinder.js"></script>
      <script type="text/javascript" src="<?= base_url(); ?>assets/libs/highcharts/code/modules/funnel3d.js"></script>
      <script type="text/javascript" src="<?= base_url(); ?>assets/libs/highcharts/code/modules/pyramid3d.js"></script>
      <script type="text/javascript" src="<?= base_url(); ?>assets/libs/highcharts/code/modules/exporting.js"></script>
      <script type="text/javascript" src="<?= base_url(); ?>assets/libs/highcharts/code/modules/export-data.js"></script>
      <script type="text/javascript" src="<?= base_url(); ?>assets/libs/highcharts/code/modules/accessibility.js"></script>
      ...
      <!-- FUNCIONES EXTERNAS - VALIDACION -->
      <script src="<?= base_url(); ?>assets/js/funciones.js"></script>
      <!-- AWESOME MARKERS PARA LEAFLET-->
      <script src="<?= base_url(); ?>assets/css/AwesomeMarkers/leaflet.awesome-markers.js"></script>
      <script src="<?= base_url(); ?>assets/css/AwesomeMarkers/leaflet.awesome-markers.min.js"></script>
