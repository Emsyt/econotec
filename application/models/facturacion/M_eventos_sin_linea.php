...
class M_eventos_sin_linea extends CI_Model {
   ...
   join cat_tipo_eventos cte
    ...
    public function M_reporte_factura_realizadas($fechaHoraInicio,$fechaHoraFin,$tipofacturadocumento,$codigodocumentosector, $id_facturacion, $id_sucursal, $cod_punto_venta, $id_evento) {
        $query = $this->db->query("SELECT * FROM fn_reporte_factura_realizadas('$fechaHoraInicio','$fechaHoraFin',$tipofacturadocumento,$codigodocumentosector, $id_facturacion, $id_sucursal, $cod_punto_venta, $id_evento)");
        return $query->result();
    }
