...
----------------------------------------------------------------------------------------
Modificado: Gary German Valverde  Fecha: 30/06/2023 Codigo:GAN-MS-A6-0528
Descripcion: Se modifico la interfaz para mostrar el proveedor +  
 */
?>
<?php
if (!defined('BASEPATH'))
...
class C_reporte_abastecimiento extends CI_Controller {
    ...
    public function generar_excel_abastecimiento(){
        ...
        $objPHPExcel->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('D7', 'Proveedor') /* G. Valverde GAN-MS-A6-0528 */
                    ->setCellValue('E7', 'Destino')
                    ->setCellValue('F7', 'Cantidad')
                    ->setCellValue('G7', 'Unidad')
                    ->setCellValue('H7', 'Precio Compra')
                    ->setCellValue('I7', 'Precio Venta')
        ...
        $objPHPExcel->getActiveSheet()->getColumnDimension('D')->setWidth('40');/* G. Valverde GAN-MS-A6-0528 */
        ...
        $objPHPExcel->getActiveSheet()->getStyle('A7:J7')->getFill()->applyFromArray(array(
        ...
        {   
            $objPHPExcel->getActiveSheet()->setCellValue('A' . $excel_row, $excel_row-7)
                                          ...
                                          ->setCellValue('D' . $excel_row, "$row->oprovedor")/* G. Valverde GAN-MS-A6-0528 */
                                          ->setCellValue('E' . $excel_row, "$row->odestino")
                                          ->setCellValue('F' . $excel_row, "$row->ocantidad")
                                          ->setCellValue('G' . $excel_row, "$row->ounidad")
                                          ->setCellValue('H' . $excel_row, "$row->opreciocompra")
                                          ->setCellValue('I' . $excel_row, "$row->oprecioventa")
                                          ->setCellValue('J' . $excel_row, "$row->ofecha");
            $objPHPExcel->getActiveSheet()->getStyle('A'.$excel_row.':J'.($excel_row))->applyFromArray($borders);                                
        ...
        $tbl1 = '
          <table cellpadding="3" border="1">
            <tr align="center" style="font-weight: bold" bgcolor="#E5E6E8">
                ...
                <th width="'.$productoWidth.'px"> Proveedor </th>
